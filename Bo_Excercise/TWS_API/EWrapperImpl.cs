...
namespace Samples
{
    ...
    //! [ewrapperimpl]
        ...
        public ContractClasses contractArray = new ContractClasses();
        //! [socket_init]

        public void printClasses()
        {
            Console.WriteLine("MAGIE AHAH; " + contractArray.ConId);
        }
        ...
        public virtual void tickPrice(int tickerId, int field, double price, TickAttrib attribs) 
        {
            ...
            contractArray.CurrentPrice = price;
        }
        //! [tickprice]
        ...
        public virtual void contractDetails(int reqId, ContractDetails contractDetails)
        {
            ...
            printContractMsg(contractDetails.Contract, reqId);
            printContractDetailsMsg(contractDetails);
            Console.WriteLine("ContractDetails end. ReqId: " + reqId);
        }
        //! [contractdetails]

        public void printContractMsg(Contract contract, int reqId)
        {
            ...
            contractArray.ConId = contract.ConId;
            contractArray.Ticker = contract.Symbol;
        }
        ...
        public void printContractDetailsMsg(ContractDetails contractDetails)
        {
            ...
            Console.WriteLine("\tIndustry: " + contractDetails.Industry);
        ...
        public virtual void historicalData(int reqId, Bar bar)
        {
            ...
            contractArray.BarCount = bar.Count;
            contractArray.HighPrice = bar.High;
            contractArray.LowPrice = bar.Low;
            contractArray.WAP = bar.WAP;
            contractArray.Price = bar.Open;
        }
        //! [historicaldata]
        ...
        public virtual void realtimeBar(int reqId, long time, double open, double high, double low, double close, decimal volume, decimal WAP, int count)
        {
            ...
            Console.WriteLine("_____________ REAL TIME BAR");
        }
        //! [realtimebar]
        ...
        public void historicalDataUpdate(int reqId, Bar bar)
        {
            Console.WriteLine("HistoricalDataUpdate. " + reqId + " - Time: " + bar.Time + ", Open: " + Util.DoubleMaxString(bar.Open) + ", High: " + Util.DoubleMaxString(bar.High) + 
                ", Low: " + Util.DoubleMaxString(bar.Low) + ", Close: " + Util.DoubleMaxString(bar.Close) + ", Volume: " + Util.DecimalMaxString(bar.Volume) + 
                ", Count: " + Util.IntMaxString(bar.Count) + ", WAP: " + Util.DecimalMaxString(bar.WAP));
            Console.WriteLine("____________________HISTORICAL DATA UDPATE");
        }
        //! [historicalDataUpdate]
        ...
        public void tickByTickBidAsk(int reqId, long time, double bidPrice, double askPrice, decimal bidSize, decimal askSize, TickAttribBidAsk tickAttribBidAsk)
        {
            ...
            Console.WriteLine("_____________________TICK BY TICK");
        }
        //! [tickbytickbidask]
